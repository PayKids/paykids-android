...
class UserRemoteDatasourceImpl @Inject constructor(
    ...
    override suspend fun saveNickname(accessToken: String): Result<BaseResponse<String>> {
        TODO("Not yet implemented")
    }

    override suspend fun changeNickname(accessToken: String): Result<BaseResponse<String>> {
        TODO("Not yet implemented")
    }
}