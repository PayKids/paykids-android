...
class QuestViewModel @Inject constructor(
    ...
    private val _questState = MutableLiveData<UiState<List<QuestInfo>>>(UiState.Loading)
    ...
    fun getQuests() {
        ...
        viewModelScope.launch {
            try {
                ...
                LoggerUtils.e("퀘스트 정보 불러오기 실패: ${e.message}")
                _questState.value = UiState.Failure(message = e.message.toString())
            }
        }
    }
